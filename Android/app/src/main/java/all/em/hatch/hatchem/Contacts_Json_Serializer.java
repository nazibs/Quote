 ...
 */
public class Contacts_Json_Serializer {

    private Context mContext;
    private String mFileName;


    public Contacts_Json_Serializer(Context mContext, String mFileName) {
    ...
    public ArrayList<Hatch_contact> loadContacts() throws IOException, JSONException {
        ...
        try {
            ...
            InputStream in = mContext.openFileInput("contacts.json");
